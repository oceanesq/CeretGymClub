...
(function () {
  ...
  if (!info || typeof CLUB_DATA === 'undefined') return;
  const c = CLUB_DATA;
  ...
  info.innerHTML = `
    <div class="contact-item">
      ...
      <div><h4>Adresse</h4><p>${c.adresse.rue}<br>${c.adresse.codePostal} ${c.adresse.ville}, ${c.adresse.pays}</p></div>
    </div>
    <div class="contact-item">
      <div class="contact-icon" aria-hidden="true">
    ...
    <div class="contact-item">
      ...
      <div>
        ...
        <p>${c.horaires_contact.join('<br>')}
        <br><em style="font-size:.82rem;color:var(--gray-400);">En dehors des créneaux, répondez à nos emails.</em></p>
      </div>
    </div>
    <div class="social-links-row" aria-label="Réseaux sociaux">
      <a href="${c.reseaux.instagram}" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram du club">
      ...
      <a href="${c.reseaux.facebook}" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook du club">
